...
struct retro_core_option_v2_definition option_defs[] = {
   ...
   {
      "fceumm_left_stick_speed",
      "Left Stick Speed",
      NULL,
      "Left stick speed for alternative controls.",
      NULL,
      "input",
      {
         { "0.03",    "0.03" },
   ...
   {
      "fceumm_right_stick_speed",
      "Right Stick Speed",
      NULL,
      "Right stick speed for alternative controls.",
      NULL,
      "input",
      {
         { "0.03",    "0.03" },
   ...
   {
      "fceumm_stick_deadzone",
      "Stick Deadzone",
      NULL,
      "Customize stick deadzone.",
      NULL,
      "input",
      {
         { "none",    "0.0" },
